...
class Messages extends CI_Controller {
	...
	public function index() {
		...
		$data = array('title' => '我的站内信', 'css' => 'space.css', );
		...
		$this -> load -> view('space/message_list');
	...
	public function letters() {
		...
		$this -> load -> view('space/space_header', $data);
		$this -> load -> view('space/space_menu');
		$this -> load -> view('space/message_list_user');
		$this -> load -> view('space/user_sidebar');
		$this -> load -> view('space/footer');
	}
	...
	public function addreplymessage() {
		if ($this -> Messages_model -> addreplymessage()) {
	...
	public function updateread() {
		if ($this -> Messages_model -> updateread()) {
			echo json_encode(array("state" => "ok"));
	...
	public function updatenoticeread() {
		if ($this -> Messages_model -> updatenoticeread()) {
			echo json_encode(array("state" => "ok"));
	...
	public function updateallowfriend() {
		if ($this -> Messages_model -> updateallowfriend()) {
			echo json_encode(array("state" => "ok"));
	...
	public function updateallowfriend2() {
		if ($this -> Messages_model -> updateallowfriend2()) {
			echo json_encode(array("state" => "ok"));
