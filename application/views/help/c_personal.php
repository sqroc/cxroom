...
<div class="container help_body">
	<div class="leftpart">
		<div class="banner">
			<img src="<?=base_url()?>images/help/banner_personal.png" />
		</div>
		<div class="warm">
		...
		<div class="box1 bg1">
			<h4>社会知名人士</h4>
			<p>包括从事创新行业的知名人士，以及因为创业或创新而被社会广泛关注的人士。</p>
		</div>
		<div class="box1 bg2">
			<h4>创业人士</h4>
			<p>正在从事创业活动的人士。</p>
		...
		<div class="box2">
			<ul>
				<li>如果你是创业者，并在创新空间发布了项目，或者他人已发布的项目成员中含有你，你的账号将默认被认证为该项目成员，无需再提交申请。</li>
				<li>如果你是知名人士，请使用你注册账号的邮箱发送个人资料到我们的认证邮箱c@cxroom.com</li>
				<li>如果你是大型创业组织的负责人，请使用你注册账号的邮箱发送个人资料到我们的认证邮箱c@cxroom.com</li>
				<li>通过创新空间邀请注册的知名人士，只需要完善资料，即可通过认证，而无需再提交资料审核。</li>
	...
	<div class="rightbar">
		<ul class="listmenu">
			<li class="current"><img src="<?=base_url()?>images/c/c_personal_little.gif" /> <a href="<?=base_url()?>help">个人认证帮助</a></li>
			<li class="normal"><img src="<?=base_url()?>images/c/c_team_little.gif" /> <a href="<?=base_url()?>help/team">团体认证帮助</a></li>
		</ul>
	</div>
	<script type="text/javascript">
		//window.onload = h;
